...
def parse_args():
    ...
    parser.add_argument('--n_tasks', help='number of tasks/clients;', type=int, required=True)
    parser.add_argument(
        '--pathological_split',
    ...
    parser.add_argument('--n_components', help='number of components/clusters; default is -1', type=int, default=3)
    parser.add_argument(
        '--alpha',
    ...
    parser.add_argument('--s_frac', help='fraction of the dataset to be used; default: 0.2;', type=float, default=0.2)
    parser.add_argument('--tr_frac', help='fraction in training set; default: 0.8;', type=float, default=0.8)
    parser.add_argument(
        '--val_frac', help='fraction in validation set (from train set); default: 0.0;', type=float, default=0.0
    )
    parser.add_argument(
        '--test_tasks_frac',
    ...
    parser.add_argument('--seed', help='seed for the random processes; default is 12345', type=int, default=12345)
...
def main():
    ...
    dataset = ConcatDataset(
        [
            EMNIST(root=RAW_DATA_PATH, split="byclass", download=True, train=True, transform=transform),
            EMNIST(root=RAW_DATA_PATH, split="byclass", download=False, train=False, transform=transform)
        ]
    )

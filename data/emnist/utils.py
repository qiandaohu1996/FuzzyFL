...
<<<<<<< HEAD
    ...
    for poor_client in poor_clients:
        while clients_counts[poor_client] < 10:  # or any other threshold you want
            # Find a rich client
            for rich_client in rich_clients:
                if clients_counts[rich_client] > 200:  # keep the rich client rich
                    # Move one sample from rich to poor
                    clients_counts[poor_client] += 10
                    clients_counts[rich_client] -= 10
                    break

...
TARGET_PATH = "all_data0/"
SEED = 1234


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--s_frac', help='fraction of data to be used; default is 0.3', type=float, default=0.3)
    ...
    parser.add_argument('--seed', help='seed for the random processes;', type=int, default=SEED, required=False)

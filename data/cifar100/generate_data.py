...
def parse_args():
    ...
    parser.add_argument('--n_components', help='number of components/clusters;', type=int, default=N_COMPONENTS)
    parser.add_argument(
        '--alpha',
    ...
    parser.add_argument('--s_frac', help='fraction of the dataset to be used; default: 1.0;', type=float, default=1.0)
    ...
    parser.add_argument('--seed', help='seed for the random processes;', type=int, default=SEED)

...
def parse_args():
    ...
    parser.add_argument('--s_frac', help='fraction of data to be used; default is 1.0', type=float, default=1.0)
    ...
    parser.add_argument(
        '--seed', help='seed for the random processes; default is 12345', type=int, default=12345, required=False
    )
...
def main():
    ...
    for idx, file_name in enumerate(file_names_list):
        ...
        save_task(dir_path=save_path, train_text=train_text, test_text=test_text, val_text=val_text)
